class BookshelfTest extends org.scalatest.funsuite.AnyFunSuite {
  test("shelfSort") {
    val input =
      """150 150 300 150 150
        ...
        |""".stripMargin
    assert(Bookshelf.shelfSort(input) === List(300, 150, 150, 150, 150))
  }
  test("bookSort") {
    val input =
      """150 150 300 150 150
        ...
        | 105 A Dance With Dragons
        |""".stripMargin
    assert(Bookshelf.bookSort(input) === List(105, 99, 76, 75, 70))
  }
  test("toShelf") {
    val input =
      """150 150 300 150 150
        ...
        | 105 A Dance With Dragons
        |""".stripMargin
    assert(Bookshelf.toShelf(input) === 2)
  }
  test("toShelf test2") {
    val input =
      """150
        | 70 A Game of Thrones
        |""".stripMargin
    assert(Bookshelf.toShelf(input) === 1)
  }
  test("toShelf test3") {
    val input =
      """500 500 500
        ...
        |399 Mission Earth
        |""".stripMargin
    assert(Bookshelf.toShelf(input) === "impossible")
  }
  test("toShelf test4") {
    val input =
      """270 142 501 865 384 957 947 603 987 428 907 10 691 707 397 917 492 750 935 672 935 712 234 683 702 508 822 379 36 59 382 280 867 155 829 756 360 995 526 52 559 250 450 843 523 446 972 555 55 985 81 831 43 802 473 379 461 639 910 529 128 878 914 426 569 59 139 913 69 649 501 889 470 112 92 6 80 571 220 22 676 91 889 799 115 194 555 477 277 718 378 838 822 358 178 562 674
        ...
        |46 b453542
        |""".stripMargin
    assert(Bookshelf.toShelf(input) === 13)
  }
}